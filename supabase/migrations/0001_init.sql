-- Esquema inicial de tienda_autos.
...
create table if not exists public.cars (
  ...
  category     text not null check (category in ('SUV', 'Sedán', 'Pick-up', 'Hatchback', 'Deportivo', 'Clásico')),
  color        text,
  image_url    text,
...
create index if not exists cars_price_idx    on public.cars (price_usd);
